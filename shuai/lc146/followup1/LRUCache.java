...
class ClearCacheThread extends Thread{
	...
	long expireTime;
	int n;
	public ClearCacheThread(DList list,ReentrantLock cacheLock, long expireTime, int n){
		this.list = list;
...
public class LRUCache {
    ...
    public LRUCache(int capacity) {
		...
		this.cacheThread = new ClearCacheThread(list, cacheLock, expireTime, n);
		cacheThread.start();
